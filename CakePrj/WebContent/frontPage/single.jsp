					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/s1.png">
								<div class="thumb-image"> <img src="../static/images/s1.png" data-imagezoom="true" class="img-responsive"></div>
							</li>
							<li data-thumb="images/s2.png">
								<div class="thumb-image"> <img src="../static/images/s2.png" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/s3.png">
							    <div class="thumb-image"> <img src="../static/images/s3.png" data-imagezoom="true" class="img-responsive"> </div>
							</li> 
						</ul>
					</div>
				</div>	
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					...
					<ul class="size">
						<h3>2-3 Tier Cakes</h3>
							<li><a href="#">1 tier</a></li>
							<li><a href="#">2 tier</a></li>
							<li><a href="#">3 tier</a></li>
					</ul>
					<div class="galry">
						<div class="prices">
